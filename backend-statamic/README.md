...
Laravel/Statamic backend for the Studio60 Challenge V2 landing page. The backend manages bilingual homepage, service, and project content, then exposes simple JSON endpoints used to export content for the Gatsby frontend.
...
-   For dynamic deployments, confirm the frontend can access the backend API URL.
-   For the current challenge submission, the deployed Gatsby frontend uses static JSON exported from these endpoints.
